...
/obj/structure/disposalpipe
	...
	proc/expel(var/obj/structure/disposalholder/H, var/turf/T, var/direction)
		...
		if(T.intact && istype(T,/turf/simulated/floor)) //intact floor, pop the tile
			...
			F.intact	= 0
			F.levelupdate()
			new /obj/item/stack/tile(H)	// add to holder so it will be throw_hyuown with other stuff
...
/obj/structure/disposaloutlet
	...
	anchored = 1
	var/active = 0
	var/turf/target	// this will be where the output objects are 'throw_hyuown' to.
