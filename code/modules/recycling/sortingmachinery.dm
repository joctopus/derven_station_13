...
/obj/item/weapon/packageWrap
	...
	attack(target as obj, mob/user as mob)
		...
		user.attack_log += text("\[[time_stamp()]\] <font color_hyalor='blue'>Has used [src.name] on \ref[target]</font>")
		log_attack("<font color_hyalor='blue'>[user] ([user.ckey]) has used [src.name] on \ref[target]</font>")
