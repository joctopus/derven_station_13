...
/obj/item/weapon/reagent_containers/food/snacks/egg
	...
	throw_hyuow_impact(atom/hit_atom)
		..()
...
/obj/item/weapon/reagent_containers/food/snacks/syndiballon
...
/obj/item/weapon/reagent_containers/food/snacks/helium_pie
	name = "helium pie"
	desc = "I bet you love stuff made out of plump helmets!"
	icon_state = "plump_pie"
	...
	New()
		..()
		reagents.add_reagent("helium", 10)
		bitesize = 2

/obj/item/weapon/reagent_containers/food/snacks/powder_pie
	name = "powder pie"
	desc = "I bet you love stuff made out of plump helmets!"
	icon_state = "plump_pie"
	...
	On_Consume()
		...
		for(var/turf/simulated/floor/target_tile in range(0,location))
			...
			e.set_up(pick(2,3,1), location, pick(3,2), 1)
			e.start()
