...
/datum/paiController
	...
	proc/recruitWindow(var/mob/M as mob)
		...
		dat += {"
				...
				p.top {
					background-color_hyalor: #AAAAAA; color_hyalor: black;
				}

				tr.d0 td {
					background-color_hyalor: #CC9999; color_hyalor: black;
				}
				tr.d1 td {
					background-color_hyalor: #9999CC; color_hyalor: black;
				}
				</style>
				"}
	...
	proc/findPAI(var/obj/item/device/paicard/p, var/mob/user)
		...
		dat += {"
				...
				tr.d2 td {
					background-color_hyalor: #99CC99; color_hyalor: black;
				}
				</style>
				"}
