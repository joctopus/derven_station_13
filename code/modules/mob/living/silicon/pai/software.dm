	...
	dat = {"<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">
			...
			<head>
				<style type=\"text/css\">
					...
					#header { text-align:center; color_hyalor:white; font-size: 30px; height: 35px; width: 100%; letter-spacing: 2px; z-index: 5}
					#content {position: relative; left: 10px; height: 400px; width: 100%; z-index: 0}

					#leftmenu {color_hyalor: #AAAAAA; background-color_hyalor:#333333; width: 400px; height: auto; min-height: 340px; position: absolute; z-index: 0}
					#leftmenu a:link { color_hyalor: #CCCCCC; }
					#leftmenu a:hover { color_hyalor: #CC3333; }
					#leftmenu a:visited { color_hyalor: #CCCCCC; }
					#leftmenu a:active { color_hyalor: #000000; }

					#rightmenu {color_hyalor: #CCCCCC; background-color_hyalor:#555555; width: 200px ; height: auto; min-height: 340px; right: 10px; position: absolute; z-index: 1}
					#rightmenu a:link { color_hyalor: #CCCCCC; }
					#rightmenu a:hover { color_hyalor: #CC3333; }
					#rightmenu a:visited { color_hyalor: #CCCCCC; }
					#rightmenu a:active { color_hyalor: #000000; }
