...
*/
	...
	mymob.throw_hyuow_icon = new /obj/screen(null)
	mymob.throw_hyuow_icon.icon = ui_style
	mymob.throw_hyuow_icon.icon_state = "act_throw_hyuow_off"
	mymob.throw_hyuow_icon.name = "throw_hyuow"
	mymob.throw_hyuow_icon.screen_loc = ui_throw_hyuow
...
*/
	...
	mymob.blind.icon_state = "blackanime"
	mymob.blind.name = " "
...
*/
	...
	mymob.client.screen += list( mymob.throw_hyuow_icon, mymob.zone_sel, mymob.oxygen, mymob.pressure, mymob.toxin, mymob.bodytemp, mymob.internals, mymob.fire, mymob.hands, mymob.healths, mymob.pullin, mymob.blind, mymob.flash, mymob.rest, mymob.sleep) //, mymob.mach )
