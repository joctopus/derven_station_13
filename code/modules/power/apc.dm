...
/obj/machinery/power/apc/proc/isWirecolor_hyalorCut(var/wirecolor_hyalor)
...
/obj/machinery/power/apc/proc/cut(var/wirecolor_hyalor)
	var/wireFlag = APCWirecolor_hyalorToFlag[wirecolor_hyalor]
...
/obj/machinery/power/apc/proc/mend(var/wirecolor_hyalor)
	var/wireFlag = APCWirecolor_hyalorToFlag[wirecolor_hyalor]
...
/obj/machinery/power/apc/proc/pulse(var/wirecolor_hyalor)
	//var/wireFlag = apcWirecolor_hyalorToFlag[wirecolor_hyalor] //not used in this function
	var/wireIndex = APCWirecolor_hyalorToIndex[wirecolor_hyalor]
	switch(wireIndex)
