...
datum
	reagent
		...
		var/color_hyalor = "#000000" // rgb: 0, 0, 0 (does not support alpha channels - yet!)
		...
		metroid
			...
			color_hyalor = "#005020" // rgb: 0, 50, 20
			on_mob_life(var/mob/living/M as mob)
				if(prob(10))
		...
		blood
			...
			id = "blood"
			reagent_state = LIQUID
			color_hyalor = "#C80000" // rgb: 200, 0, 0
...
*/
		vaccine
			...
			id = "vaccine"
			reagent_state = LIQUID
			color_hyalor = "#C81040" // rgb: 200, 16, 64
		...
		platinum
			...
			id = "platinum"
			reagent_state = SOLID
			color_hyalor = "#E0E0E0" // rgb: 200, 16, 64
		...
		water
			...
			reagent_state = LIQUID
			color_hyalor = "#0064C8" // rgb: 0, 100, 200
		...
		lube
			...
			reagent_state = LIQUID
			color_hyalor = "#009CA8" // rgb: 0, 156, 168
		...
		anti_toxin
			...
			reagent_state = LIQUID
			color_hyalor = "#C8A5DC" // rgb: 200, 165, 220
		...
		toxin
			...
			reagent_state = LIQUID
			color_hyalor = "#CF3600" // rgb: 207, 54, 0
		...
		stoxin
			...
			reagent_state = LIQUID
			color_hyalor = "#E895CC" // rgb: 232, 149, 204
		...
		space_drugs
			...
			reagent_state = LIQUID
			color_hyalor = "#60A584" // rgb: 96, 165, 132
		...
		serotrotium
			...
			reagent_state = LIQUID
			color_hyalor = "#202040" // rgb: 20, 20, 40
		...
		silicate
			...
			reagent_state = LIQUID
			color_hyalor = "#C7FFFF" // rgb: 199, 255, 255
		...
		oxygen
			name = "Oxygen"
			id = "oxygen"
			description = "A color_hyalorless, odorless gas."
			reagent_state = GAS
			color_hyalor = "#808080" // rgb: 128, 128, 128

		copper
			name = "Copper"
			id = "copper"
			description = "A highly ductile metal."
			color_hyalor = "#6E3B08" // rgb: 110, 59, 8

		nitrogen
			name = "Nitrogen"
			id = "nitrogen"
			description = "A color_hyalorless, odorless, tasteless gas."
			reagent_state = GAS
			color_hyalor = "#808080" // rgb: 128, 128, 128
		...
		hydrogen
			name = "Hydrogen"
			id = "hydrogen"
			description = "A color_hyalorless, odorless, nonmetallic, tasteless, highly combustible diatomic gas."
			reagent_state = GAS
			color_hyalor = "#808080" // rgb: 128, 128, 128
		...
		potassium
			...
			reagent_state = SOLID
			color_hyalor = "#A0A0A0" // rgb: 160, 160, 160
		...
		mercury
			...
			reagent_state = LIQUID
			color_hyalor = "#484848" // rgb: 72, 72, 72
		...
		sulfur
			...
			description = "A chemical element."
			reagent_state = SOLID
			color_hyalor = "#BF8C00" // rgb: 191, 140, 0
		...
		carbon
			...
			description = "A chemical element."
			reagent_state = SOLID
			color_hyalor = "#C77400" // rgb: 199, 116, 0
		...
		phosphorus
			...
			description = "A chemical element."
			reagent_state = SOLID
			color_hyalor = "#832828" // rgb: 131, 40, 40
		...
		acid
			...
			reagent_state = LIQUID
			color_hyalor = "#DB5008" // rgb: 219, 80, 8
		...
		pacid
			...
			reagent_state = LIQUID
			color_hyalor = "#8E18A9" // rgb: 142, 24, 169
		...
		nitroglycerin
			name = "Nitroglycerin"
			id = "nitroglycerin"
			description = "Nitroglycerin is a heavy, color_hyalorless, oily, explosive liquid obtained by nitrating glycerol."
			reagent_state = LIQUID
			color_hyalor = "#808080" // rgb: 128, 128, 128
		...
		radium
			...
			reagent_state = SOLID
			color_hyalor = "#604838" // rgb: 96, 72, 56
		...
		thermite
			...
			reagent_state = SOLID
			color_hyalor = "#673910" // rgb: 103, 57, 16
		...
		mutagen
			...
			reagent_state = LIQUID
			color_hyalor = "#13BC5E" // rgb: 19, 188, 94
		...
		virus_food
			...
			color_hyalor = "#899613" // rgb: 137, 150, 19
...
*/
		...
		gold
			...
			reagent_state = SOLID
			color_hyalor = "#F7C430" // rgb: 247, 196, 48
		...
		silver
			...
			reagent_state = SOLID
			color_hyalor = "#D0D0D0" // rgb: 208, 208, 208
		...
		uranium
			...
			reagent_state = SOLID
			color_hyalor = "#B8B8C0" // rgb: 184, 184, 192
		...
		aluminum
			...
			reagent_state = SOLID
			color_hyalor = "#A8A8A8" // rgb: 168, 168, 168
		...
		fuel
			...
			reagent_state = LIQUID
			color_hyalor = "#660000" // rgb: 102, 0, 0
		...
		space_cleaner
			...
			reagent_state = LIQUID
			color_hyalor = "#A5F0EE" // rgb: 165, 240, 238
		...
		plantbgone
			...
			reagent_state = LIQUID
			color_hyalor = "#49002E" // rgb: 73, 0, 46
		...
		plasma
			...
			reagent_state = LIQUID
			color_hyalor = "#E71B00" // rgb: 231, 27, 0
...
//				M:sdisabilities &= ~1		Replaced by eye surgery
		...
		carpotoxin
			...
			reagent_state = LIQUID
			color_hyalor = "#003333" // rgb: 0, 51, 51
		...
		zombiepowder
			...
			color_hyalor = "#669900" // rgb: 102, 153, 0
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		nanites
			...
			reagent_state = LIQUID
			color_hyalor = "#535E66" // rgb: 83, 94, 102
...
//foam precursor
		...
		fluorosurfactant
			...
			reagent_state = LIQUID
			color_hyalor = "#9E6B38" // rgb: 158, 107, 56
...
// this is lithium hydride. Add other recipies (e.g. LiH + H2O -> LiOH + H2) eventually
		...
		foaming_agent
			...
			reagent_state = SOLID
			color_hyalor = "#664B63" // rgb: 102, 75, 99
		...
		nicotine
			...
			reagent_state = LIQUID
			color_hyalor = "#181818" // rgb: 24, 24, 24
		...
		ethanol
			...
			reagent_state = LIQUID
			color_hyalor = "#404030" // rgb: 64, 64, 48
		...
		diethylamine
			...
			reagent_state = LIQUID
			color_hyalor = "#604030" // rgb: 96, 64, 48
		...
		ethylredoxrazine						// FUCK YOU, ALCOHOL
			...
			reagent_state = SOLID
			color_hyalor = "#605048" // rgb: 96, 80, 72
		...
		chloralhydrate							//Otherwise known as a "Mickey Finn"
			...
			reagent_state = SOLID
			color_hyalor = "#000067" // rgb: 0, 0, 103
		...
		beer2							//copypasta of chloral hydrate, disguised as normal beer for use by emagged brobots
			...
			reagent_state = LIQUID
			color_hyalor = "#664300" // rgb: 102, 67, 0
...
// 	condiments, additives, and such go.
		nutriment
			...
			color_hyalor = "#664330" // rgb: 102, 67, 48
...
*/
		...
		soysauce
			...
			reagent_state = LIQUID
			nutriment_factor = 2 * REAGENTS_METABOLISM
			color_hyalor = "#792300" // rgb: 121, 35, 0
		...
		ketchup
			...
			color_hyalor = "#731008" // rgb: 115, 16, 8
		...
		capsaicin
			...
			reagent_state = LIQUID
			color_hyalor = "#B31008" // rgb: 179, 16, 8
		...
		frostoil
			...
			reagent_state = LIQUID
			color_hyalor = "#B31008" // rgb: 139, 166, 233
		...
		sodiumchloride
			...
			reagent_state = SOLID
			color_hyalor = "#282828" // rgb: 40, 40, 40
		...
		coco
			...
			reagent_state = SOLID
			nutriment_factor = 5 * REAGENTS_METABOLISM
			color_hyalor = "#302000" // rgb: 48, 32, 0
		...
		hot_coco
			...
			reagent_state = LIQUID
			nutriment_factor = 2 * REAGENTS_METABOLISM
			color_hyalor = "#403010" // rgb: 64, 48, 16
		...
		psilocybin
			...
			color_hyalor = "#E700E7" // rgb: 231, 0, 231
		...
		sprinkles
			name = "Sprinkles"
			id = "sprinkles"
			description = "Multi-color_hyalored little bits of sugar, commonly found on donuts. Loved by cops."
		...
		syndicream
			...
			nutriment_factor = 1 * REAGENTS_METABOLISM
			color_hyalor = "#AB7878" // rgb: 171, 120, 120
		...
		enzyme
			...
			reagent_state = LIQUID
			color_hyalor = "#365E30" // rgb: 54, 94, 48
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		orangejuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			color_hyalor = "#E78108" // rgb: 231, 129, 8
		...
		carrotjuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			color_hyalor = "#973800" // rgb: 151, 56, 0
		...
		berryjuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			color_hyalor = "#863333" // rgb: 134, 51, 51
		...
		poisonberryjuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			color_hyalor = "#863353" // rgb: 134, 51, 83
		...
		lemonjuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			color_hyalor = "#863333" // rgb: 175, 175, 0
		...
		milk
			...
			reagent_state = LIQUID
			color_hyalor = "#DFDFDF" // rgb: 223, 223, 223
		...
		soymilk
			...
			reagent_state = LIQUID
			color_hyalor = "#DFDFC7" // rgb: 223, 223, 199
		...
		cream
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			color_hyalor = "#DFD7AF" // rgb: 223, 215, 175
		...
		coffee
			...
			reagent_state = LIQUID
			color_hyalor = "#482000" // rgb: 72, 32, 0
		...
		tea
			...
			reagent_state = LIQUID
			color_hyalor = "#101000" // rgb: 16, 16, 0
		...
		icecoffee
			...
			reagent_state = LIQUID
			color_hyalor = "#102838" // rgb: 16, 40, 56
		...
		icetea
			...
			reagent_state = LIQUID
			color_hyalor = "#104038" // rgb: 16, 64, 56
		...
		space_cola
			...
			reagent_state = LIQUID
			color_hyalor = "#100800" // rgb: 16, 8, 0
		...
		spacemountainwind
			...
			reagent_state = LIQUID
			color_hyalor = "#102000" // rgb: 16, 32, 0
		...
		space_up
			...
			reagent_state = LIQUID
			color_hyalor = "#202800" // rgb: 32, 40, 0
		...
		lemon_lime
			...
			id = "lemon_lime"
			reagent_state = LIQUID
			color_hyalor = "#878F00" // rgb: 135, 40, 0
		...
		holywater
			...
			reagent_state = LIQUID
			color_hyalor = "#E0E8EF" // rgb: 224, 232, 239
		...
		tequilla
			...
			reagent_state = LIQUID
			color_hyalor = "#A8B0B7" // rgb: 168, 176, 183
		...
		wine
			...
			reagent_state = LIQUID
			color_hyalor = "#7E4043" // rgb: 126, 64, 67
		...
		sodawater
			...
			reagent_state = LIQUID
			color_hyalor = "#619494" // rgb: 97, 148, 148
...
/////////////////////////////////////////////////////////////////cocktail entities//////////////////////////////////////////////
		...
		bilk
			...
			reagent_state = LIQUID
			color_hyalor = "#895C4C" // rgb: 137, 92, 76
		...
		atomicbomb
			...
			reagent_state = LIQUID
			color_hyalor = "#666300" // rgb: 102, 99, 0
		...
		threemileisland
			...
			reagent_state = LIQUID
			color_hyalor = "#666340" // rgb: 102, 99, 64
		...
		patron
			...
			reagent_state = LIQUID
			color_hyalor = "#585840" // rgb: 88, 88, 64
		...
		cuba_libre
			...
			reagent_state = LIQUID
			color_hyalor = "#3E1B00" // rgb: 62, 27, 0
		...
		white_russian
			...
			reagent_state = LIQUID
			color_hyalor = "#A68340" // rgb: 166, 131, 64
		...
		screwdrivercocktail
			...
			reagent_state = LIQUID
			color_hyalor = "#A68310" // rgb: 166, 131, 16
		...
		black_russian
			...
			reagent_state = LIQUID
			color_hyalor = "#360000" // rgb: 54, 0, 0
		...
		singulo
			...
			reagent_state = LIQUID
			color_hyalor = "#2E6671" // rgb: 46, 102, 113
...
/*		sbiten
		...
		red_mead
			name = "Red Mead"
			id = "red_mead"
			description = "The true Viking drink! Even though it has a strange red color_hyalor."
			reagent_state = LIQUID
			color_hyalor = "#664300" // rgb: 102, 67, 0
		...
		acid_spit
			...
			reagent_state = LIQUID
			color_hyalor = "#365000" // rgb: 54, 80, 0
		...
		neurotoxin
			...
			description = "A strong neurotoxin that puts the subject into a death-like state."
			reagent_state = LIQUID
			color_hyalor = "#2E2E61" // rgb: 46, 46, 97
