...
About Reagents:
	...
	Important variables:
		...
		color_hyalor
			This is a hexadecimal color_hyalor that represents the reagent outside of containers,
			you define it as "#RRGGBB", or, red green blue. You can also define it using the
			rgb() proc, which returns a hexadecimal value too. The color_hyalor is black by default.

			A good website for color_hyalor calculations: http://www.psyclops.com/tools/rgb/
