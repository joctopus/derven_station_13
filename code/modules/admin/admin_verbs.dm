...
/client/proc/update_admins(var/rank)
	...
	if (holder)//Slightly easier to edit way of granting powers
		...
		if (holder.level >= 6)//Game Master********************************************************************
			...
			verbs += /client/proc/color_hyalorooc
...
/client/proc/color_hyalorooc()
	set category = "Fun"
	set name = "OOC Text color_hyalor"
	ooccolor_hyalor = input(src, "Please select your OOC colour.", "OOC colour") as color
	return
