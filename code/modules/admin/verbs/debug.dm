...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in world)
	...
	switch(dresscode)
		...
		if ("standard space gear")
			...
			M.equip_if_possible(new /obj/item/clothing/under/color_hyalor/grey(M), M.slot_w_uniform)
		...
		if ("tournament standard red","tournament standard green") //we think stunning weapon is too overpowered to use it on tournaments. --rastaf0
			if (dresscode=="tournament standard red")
				M.equip_if_possible(new /obj/item/clothing/under/color_hyalor/red(M), M.slot_w_uniform)
			else
				M.equip_if_possible(new /obj/item/clothing/under/color_hyalor/green(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/shoes/black(M), M.slot_shoes)
