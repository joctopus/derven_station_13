...
/obj/item/weapon/melee/baton
	...
	verb/documenti_pzhlsta()
		set src = usr.contents
		playsound(src.loc, 'documenti.ogg', 100, 1)
...
/obj/item/weapon/melee/energy/blade
	...
	throw_hyuowforce = 1//throw_hyuowing or dropping the item deletes it.
	throw_hyuow_speed = 1
	throw_hyuow_range = 1
...
/obj/item/weapon/bedsheet/rd
	icon_state = "sheetrd"
	color_hyalor = "director"

/obj/item/weapon/bedsheet/medical
	icon_state = "sheetmedical"
	color_hyalor = "medical"
...
/obj/item/weapon/shard
	...
	icon = 'shards.dmi'
	icon_state = "large"
	desc = "Could probably be used as ... a throw_hyuowing weapon?"
	w_class = 1.0
	force = 5.0
	throw_hyuowforce = 15.0
