...
/obj/machinery/mass_driver
	...
	var/id = 1.0
	anchored = 1.0
	var/drive_range = 50 //this is mostly irrelevant since current mass drivers throw_hyuow into space, but you could make a lower-range mass driver for interstation transport or something I guess.
	use_power = 1
	idle_power_usage = 2
