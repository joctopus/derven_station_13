...
/obj/item/stack/tile/steel
	...
	desc = "Those could work as a pretty decent throw_hyuowing weapon"
	icon_state = "tile"
	w_class = 3.0
	force = 6.0
	m_amt = 937.5
...
/obj/item/weapon/beach_ball
	...
	w_class = 1.0
	force = 0.0
	throw_hyuowforce = 0.0
	throw_hyuow_speed = 1
	throw_hyuow_range = 20
	flags = FPRINT | USEDELAY | TABLEPASS | CONDUCT
	afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
		user.drop_item()
		src.throw_hyuow_at(target, throw_hyuow_range, throw_hyuow_speed)
