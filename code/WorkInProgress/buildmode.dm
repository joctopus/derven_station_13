...
/obj/bmode/buildhelp
	...
	Click()
		switch(master.cl.buildmode)
			...
			if(4)
				usr << "\blue ***********************************************************"
				usr << "\blue Left Mouse Button on turf/obj/mob      = throw_hyuow"
...
/obj/bmode/buildholder
	...
	var/atom/movable/throw_hyuow_atom = null
...
/proc/build_click(var/mob/user, buildmode, location, control, params, var/obj/object)
	...
	switch(buildmode)
		...
		if(4)
			if(pa.Find("left"))
				holder.throw_hyuow_atom = object
			if(pa.Find("right"))
				if(holder.throw_hyuow_atom)
					holder.throw_hyuow_atom.throw_hyuow_at(object, 10, 1)
