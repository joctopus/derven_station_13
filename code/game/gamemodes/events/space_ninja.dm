...
/mob/living/carbon/human/proc/equip_space_ninja(safety=0)//Safety in case you need to unequip stuff for existing characters.
	...
	if(gender==FEMALE)
		equip_if_possible(new /obj/item/clothing/under/color_hyalor/blackf(src), slot_w_uniform)
	else
		equip_if_possible(new /obj/item/clothing/under/color_hyalor/black(src), slot_w_uniform)
