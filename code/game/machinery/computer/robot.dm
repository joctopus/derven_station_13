			...
			for(var/mob/living/silicon/robot/R in world)
				...
				if (istype(user, /mob/living/silicon))
					if((user.mind.special_role && user.mind.original == user) && !R.emagged)
						dat += "<A href='?src=\ref[src];magbot=\ref[R]'>(<font color_hyalor=blue><i>Hack</i></font>)</A> "
				dat += "<A href='?src=\ref[src];stopbot=\ref[R]'>(<font color_hyalor=green><i>[R.canmove ? "Lockdown" : "Release"]</i></font>)</A> "
				dat += "<A href='?src=\ref[src];killbot=\ref[R]'>(<font color_hyalor=red><i>Destroy</i></font>)</A>"
				dat += "<BR>"
