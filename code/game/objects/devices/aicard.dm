/obj/item/device/aicard
	...
	attack(mob/living/silicon/ai/M as mob, mob/user as mob)
		...
		M.attack_log += text("\[[time_stamp()]\] <font color_hyalor='orange'>Has been carded with [src.name] by [user.name] ([user.ckey])</font>")
		user.attack_log += text("\[[time_stamp()]\] <font color_hyalor='red'>Used the [src.name] to card [M.name] ([M.ckey])</font>")

		log_attack("<font color_hyalor='red'>[user.name] ([user.ckey]) used the [src.name] to card [M.name] ([M.ckey])</font>")
