...
/obj/item/weapon/melee/energy/sword/New()
	color_hyalor = pick("red","blue","green","purple")
...
/obj/item/weapon/melee/energy/blade/proc/throw_hyuow()
	del(src)
	return
...
/obj/item/weapon/melee/baton/attack(mob/M as mob, mob/user as mob)
	...
	M.attack_log += text("\[[time_stamp()]\] <font color_hyalor='orange'>Has been attacked with [src.name] by [user.name] ([user.ckey]) (INTENT: [uppertext(user.a_intent)])</font>")
	user.attack_log += text("\[[time_stamp()]\] <font color_hyalor='red'>Used the [src.name] to attack [M.name] ([M.ckey]) (INTENT: [uppertext(user.a_intent)])</font>")

	log_attack("<font color_hyalor='red'>[user.name] ([user.ckey]) attacked [M.name] ([M.ckey]) with [src.name] (INTENT: [uppertext(user.a_intent)])</font>")
...
/obj/item/weapon/melee/classic_baton/attack(mob/M as mob, mob/living/user as mob)
	...
	M.attack_log += text("\[[time_stamp()]\] <font color_hyalor='orange'>Has been attacked with [src.name] by [user.name] ([user.ckey])</font>")
	user.attack_log += text("\[[time_stamp()]\] <font color_hyalor='red'>Used the [src.name] to attack [M.name] ([M.ckey])</font>")
