...
/obj/item/weapon/pen/proc/formatText(var/s)
	if (text_size < 2 || text_size > 7)
		text_size = 3
	if (!(text_color_hyalor))
		text_color_hyalor = "#000000"

	var/textToAddHeader = ""
	var/textToAddFooter = ""

	if (text_color_hyalor && text_size)
		textToAddHeader = "<font size=[text_size] color_hyalor=[text_color_hyalor]>"
...
/obj/item/weapon/pen/attack_self(mob/user as mob)
	...
	dat += text("<b>color_hyalor:</b><br>")
	dat += text("<A href='?src=\ref[src];color_hyalor=["000000"]'><font color_hyalor=black>black:</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["222222"]'><font color_hyalor=#222222>1</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["444444"]'><font color_hyalor=#444444>2</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["666666"]'><font color_hyalor=#666666>3</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["888888"]'><font color_hyalor=#888888>4</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["AAAAAA"]'><font color_hyalor=#AAAAAA>5</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["CCCCCC"]'><font color_hyalor=#CCCCCC>6</font></A><br>")

	dat += text("<A href='?src=\ref[src];color_hyalor=["FF0000"]'><font color_hyalor=#FF0000>Red:</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["440000"]'><font color_hyalor=#440000>1</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["880000"]'><font color_hyalor=#880000>2</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["CC0000"]'><font color_hyalor=#CC0000>3</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FF2222"]'><font color_hyalor=#FF2222>4</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FF6666"]'><font color_hyalor=#FF6666>5</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FFBBBB"]'><font color_hyalor=#FFBBBB>6</font></A><br>")

	dat += text("<A href='?src=\ref[src];color_hyalor=["FFFF00"]'><font color_hyalor=#FFFF00>Yellow:</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["444400"]'><font color_hyalor=#444400>1</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["888800"]'><font color_hyalor=#888800>2</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["CCCC00"]'><font color_hyalor=#CCCC00>3</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FFFF22"]'><font color_hyalor=#FFFF22>4</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FFFF66"]'><font color_hyalor=#FFFF66>5</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FFFFBB"]'><font color_hyalor=#FFFFBB>6</font></A><br>")

	dat += text("<A href='?src=\ref[src];color_hyalor=["00FF00"]'><font color_hyalor=#00FF00>Green:</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["004400"]'><font color_hyalor=#004400>1</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["008800"]'><font color_hyalor=#008800>2</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["00CC00"]'><font color_hyalor=#00CC00>3</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["22FF22"]'><font color_hyalor=#22FF22>4</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["66FF66"]'><font color_hyalor=#66FF66>5</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["BBFFBB"]'><font color_hyalor=#BBFFBB>6</font></A><br>")

	dat += text("<A href='?src=\ref[src];color_hyalor=["00FFFF"]'><font color_hyalor=#00FFFF>Cyan:</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["004444"]'><font color_hyalor=#004444>1</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["008888"]'><font color_hyalor=#008888>2</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["00CCCC"]'><font color_hyalor=#00CCCC>3</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["22FFFF"]'><font color_hyalor=#22FFFF>4</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["66FFFF"]'><font color_hyalor=#66FFFF>5</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["BBFFFF"]'><font color_hyalor=#BBFFFF>6</font></A><br>")

	dat += text("<A href='?src=\ref[src];color_hyalor=["0000FF"]'><font color_hyalor=#0000FF>Blue:</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["000044"]'><font color_hyalor=#000044>1</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["000088"]'><font color_hyalor=#000088>2</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["0000CC"]'><font color_hyalor=#0000CC>3</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["2222FF"]'><font color_hyalor=#2222FF>4</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["6666FF"]'><font color_hyalor=#6666FF>5</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["BBBBFF"]'><font color_hyalor=#BBBBFF>6</font></A><br>")

	dat += text("<A href='?src=\ref[src];color_hyalor=["000000"]'><font color_hyalor=#FF00FF>Purple:</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["440044"]'><font color_hyalor=#440044>1</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["880088"]'><font color_hyalor=#880088>2</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["CC00CC"]'><font color_hyalor=#CC00CC>3</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FF22FF"]'><font color_hyalor=#FF22FF>4</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FF66FF"]'><font color_hyalor=#FF66FF>5</font></A> ")
	dat += text("<A href='?src=\ref[src];color_hyalor=["FFBBFF"]'><font color_hyalor=#FFBBFF>6</font></A><br><br>")
...
/obj/item/weapon/pen/Topic(href, href_list)
	usr.machine = src
	if(href_list["color_hyalor"])
		src.text_color_hyalor = "#"
		src.text_color_hyalor += href_list["color_hyalor"]
	if(href_list["size"])
...
/obj/item/weapon/wrapping_paper/attack(mob/target as mob, mob/user as mob)
	...
	if (istype(target:wear_suit, /obj/item/clothing/suit/straight_jacket) || target:stat)
		if (src.amount > 2)
			...
			target:loc = present
			target.attack_log += text("\[[time_stamp()]\] <font color_hyalor='orange'>Has been wrapped with [src.name]  by [user.name] ([user.ckey])</font>")
			user.attack_log += text("\[[time_stamp()]\] <font color_hyalor='red'>Used the [src.name] to wrap [target.name] ([target.ckey])</font>")

			log_attack("<font color_hyalor='red'>[user.name] ([user.ckey]) used the [src.name] to wrap [target.name] ([target.ckey])</font>")
