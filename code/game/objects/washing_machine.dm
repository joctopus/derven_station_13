...
/obj/machinery/washing_machine/verb/start()
	...
	if(crayon)
		...
		if(color_hyalor)
			...
			var/new_sheet_name = ""
			var/new_desc = "The color_hyalors are a bit dodgy."
			for(var/T in typesof(/obj/item/clothing/under))
				var/obj/item/clothing/under/J = new T
				//world << "DEBUG: [color_hyalor] == [J.color_hyalor]"
				if(color_hyalor == J.color_hyalor)
			...
			for(var/T in typesof(/obj/item/clothing/gloves))
				...
				//world << "DEBUG: [color_hyalor] == [J.color_hyalor]"
				if(color_hyalor == G.color_hyalor)
			...
			for(var/T in typesof(/obj/item/clothing/shoes))
				...
				//world << "DEBUG: [color_hyalor] == [J.color_hyalor]"
				if(color_hyalor == S.color_hyalor)
			...
			for(var/T in typesof(/obj/item/weapon/bedsheet))
				...
				//world << "DEBUG: [color_hyalor] == [J.color_hyalor]"
				if(color_hyalor == B.color_hyalor)
