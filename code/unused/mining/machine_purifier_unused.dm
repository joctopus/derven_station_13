...
/obj/machinery/mineral/purifier/attack_hand(user as mob)
	...
	if (input)
		dat += text("<b><font color_hyalor='green'>CONNECTED</font></b>")
	else
		dat += text("<b><font color_hyalor='red'>NOT CONNECTED</font></b>")
	...
	dat += text("<br><br>found: <font color_hyalor='green'><b>[processed]</b></font>")
