...
//Module Panel
	...
	using.screen_loc = ui_throw_hyuow
	using.layer = 19
	src.adding += using

//Store
	mymob.throw_hyuow_icon = new /obj/screen(null)
	mymob.throw_hyuow_icon.icon = 'screen1_robot.dmi'
	mymob.throw_hyuow_icon.icon_state = "store"
	mymob.throw_hyuow_icon.name = "store"
	mymob.throw_hyuow_icon.screen_loc = ui_hand
...
//does nothing (fire and oxy)
	...
	mymob.client.screen += list(mymob.throw_hyuow_icon, mymob.zone_sel, mymob.oxygen, mymob.fire, mymob.hands, mymob.healths, mymob:cells, mymob.pullin, mymob.blind, mymob.flash, mymob.rest, mymob.sleep) //, mymob.mach )
