...
/datum/game_mode/monkey/declare_completion()
	...
	if (monkeywin)
		...
		world << "<FONT size=3 color_hyalor=red><B>The monkeys have won! Humanity is doomed!</B></FONT>"
		...
		world << "<FONT size=3 color_hyalor=red><B>The Research Staff has stopped the monkey invasion!</B></FONT>"
	..()
	return 1
