...
*/
		switch(src.build_status)
			if("unbuilt")
				dat += "<h3>Core Status: <font color_hyalor =#FF3300>Undeployed</font></h3><BR>"
				dat += "<A href='?src=\ref[src];groupself=1'>Build Ship</A><BR>"
			if("built")
				dat += "<h3>Core Status: <font color_hyalor =#00CC00>Deployed</font></h3><BR>"
				dat += "<A href='?src=\ref[src];move=1'>Move</A><BR>"
			if("rebuilding")
				dat += "<h3>Core Status: <font color_hyalor =#FFCC00>Recalibrating</font></h3><BR>"
	...
	attack_hand(user as mob)
		...
		if(!src.core)
			...
			for(var/obj/machinery/ship_component/C in core.components)
				dat += "<tr><td><b>[C.name]</b></td><td>[C.active ? "<font color_hyalor=green>Active</font>" : "<font color_hyalor=red>Inactive</font>"]</td></tr>"
